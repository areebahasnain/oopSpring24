...
public:
    ...
    vector<int> purchased_items; // stores indices of purchased items
    float total;
...
int main()
{
    ...
    user.accumulate_coupon(BOGOCoupon("22448", "PB", 0, 30));
    ...
    while(flag) {
        ...
        case 3:
            ...
            if (res == 1) fh.purchased_items.push_back(item);
            else if (res == 2) pb.purchased_items.push_back(item);
